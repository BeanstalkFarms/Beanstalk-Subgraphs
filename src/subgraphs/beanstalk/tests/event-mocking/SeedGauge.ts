...
export function createTotalStalkChangedFromGerminationEvent(
  deltaStalk: BigInt,
  deltaRoots: BigInt
): TotalStalkChangedFromGermination {
...
export function createUpdateGaugeSettingsEvent(
  ...
  let param4 = new ethereum.EventParam(
    "optimalPercentDepositedBdv",
    ethereum.Value.fromUnsignedBigInt(optimalPercentDepositedBdv)
  );

  ...
  if (baseHourly !== null) {
    ...
    if (hourly.id == baseHourly.id) {
      ...
      if (hourly.deltaOptimalPercentDepositedBdv !== null && baseHourly.deltaOptimalPercentDepositedBdv !== null) {
        hourly.deltaOptimalPercentDepositedBdv = hourly.deltaOptimalPercentDepositedBdv!.plus(
          baseHourly.deltaOptimalPercentDepositedBdv!
        );
      }
    }
  } else {
  ...
  if (baseDaily !== null) {
    ...
    if (daily.id == baseDaily.id) {
      ...
      if (daily.deltaOptimalPercentDepositedBdv !== null && baseDaily.deltaOptimalPercentDepositedBdv !== null) {
        daily.deltaOptimalPercentDepositedBdv = daily.deltaOptimalPercentDepositedBdv!.plus(
          baseDaily.deltaOptimalPercentDepositedBdv!
        );
      }
    }
  } else {
